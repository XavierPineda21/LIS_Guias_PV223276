...
$backlink .= "<span class=\"a-btn-slide-
text\">nuevamente</span>";
$backlink .= "</a>";
echo $backlink;
exit(0);
endif;
...
echo "<span class='d-block h3 font-weight-normal'>Ingresar nuevosdatos</span>";
else:
?>
...
<input type="submit" name="enviar" value="Generar" class="btn btn-
primary" />&nbsp;
<input type="reset" name="limpiar" value="Cancelar" class="btn btn-
primary" />
</form>
