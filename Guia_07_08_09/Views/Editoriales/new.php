            ...
            <div class="col-md-7">
                <form role="form" action="<?= PATH?>/editoriales/insert" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        id="codigo_editorial" value="<?=empty($editorial['codigo_editorial'])?'':$editorial['codigo_editorial']?>"
                    ...
                    <div class="mb-3">
                        ...
                        id="nombre_editorial" value="<?=empty($editorial['nombre_editorial'])?'':$editorial['nombre_editorial']?>"
                         placeholder="Ingresa el nombre del editorial">
                    </div>
                    <div class="mb-3">
                        <label for="contacto" class="form-label">Contacto:</label>
                        <input type="text" class="form-control" id="contacto" value="<?=empty($editorial['contacto'])?'':$editorial['contacto']?>"
                        name="contacto" placeholder="Ingresa el nombre del contacto">
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="form-label">Teléfono:</label>
                        <input type="tel" class="form-control" id="telefono" value="<?=empty($editorial['telefono'])?'':$editorial['telefono']?>"
                        name="telefono" placeholder="Ingresa el teléfono del contacto">
                    </div>
