...
echo "<div class='alert alert-danger text-center mt-3'>Por favor, ingrese un año válido mayor a 1900 y menor o igual a
$currentYear.</div>";
echo "<div class='text-center mt-3'><a href='" .
$_SERVER['PHP_SELF'] . "' class='btn btn-secondary'>Intentar de nuevo</a></div>";
} elseif (($year % 4 === 0 && $year % 100 !== 0) ||
($year % 400 === 0)) {
echo "<div class='alert alert-success text-center mt-3'>El año $year es bisiesto.</div>";
} else {
...
|| !Number.isInteger(Number(yearInput))) {
    alert(`Por favor, ingrese un año válido mayor a 1900 y menor o igual a ${currentYear}.`);
return false;
}
return true;
}
